...
INSERT INTO user(firstname, lastname, email, DOB, password, is_verify) values("ADMIN 2", "CP24NW1", "admin2@mailinator.com", "2002-11-28", "$2b$10$FLZFnRG6EOnJmT7TA/cNyuVDRZD.wqNODac4HrX1AIa9fA/e4YJm.", 1);
...
(1, NULL, 3, 'What does "elaborate" mean?'),
(1, NULL, 3, 'What is a synonym for "happy"?'),
(1, NULL, 3, 'What is the opposite of "hot"?'),
(1, NULL, 3, 'What does "eclectic" mean?'),
(1, NULL, 3, 'What is a synonym for "beautiful"?'),
(1, NULL, 3, 'What does "amplify" mean?'),
(1, NULL, 3, 'What is the meaning of "benevolent"?'),
(1, NULL, 3, 'Which word is a synonym for "quick"?'),
(1, NULL, 3, 'What is an antonym of "bright"?'),
(1, NULL, 3, 'Which word means "to explain in detail"?'),

(2, NULL, 3, 'Which sentence is in the present perfect tense?'),
(2, NULL, 3, 'What is the past participle of "write"?'),
(2, NULL, 3, 'Which sentence uses future continuous tense?'),
(2, NULL, 3, 'Identify the correct past simple form: "Yesterday, she _____ (go) to the mall."'),
(2, NULL, 3, 'Choose the correct conditional sentence (Type 2).'),
(2, NULL, 3, 'Which tense is used in this sentence: "I will have finished my work by tomorrow"?'),
(2, NULL, 3, 'Choose the sentence in past perfect tense.'),
(2, NULL, 3, 'Which tense is correct: "I am playing soccer now."'),
(2, NULL, 3, 'Identify the future perfect tense sentence.'),
(2, NULL, 3, 'Which sentence is in present continuous tense?'),

(3, NULL, 3, 'What is the past tense of "go"?'),
(3, NULL, 3, 'Choose the correct article: "___ apple"'),
(3, NULL, 3, 'Which word is a verb? "run" or "tree"?'),
(3, NULL, 3, 'Fill in the blank: "I ____ to the store"'),
(3, NULL, 3, 'Which of the following is an adjective?'),
(3, NULL, 3, 'Identify the subject in the sentence: "She runs every day."'),
(3, NULL, 3, 'Choose the correct preposition: "She is ___ the table."'),
(3, NULL, 3, 'What is the past tense of "eat"?'),
(3, NULL, 3, 'What is the plural form of "child"?'),
(3, NULL, 3, 'Which sentence is correct? "I has a book" or "I have a book"?'),

(4, NULL, 3, 'What is the main idea of the passage?'),
(4, NULL, 3, 'What can be inferred from the last paragraph?'),
(4, NULL, 3, 'What does the word "convey" mean in the context?'),
(4, NULL, 3, 'Which statement best summarizes the passage?'),
(4, NULL, 3, 'What is the author’s purpose in writing this text?'),
(4, NULL, 3, 'Which sentence provides evidence for the main argument?'),
(4, NULL, 3, 'What does the phrase "according to the text" suggest?'),
(4, NULL, 3, 'Which statement is NOT supported by the passage?'),
(4, NULL, 3, 'How does paragraph 2 support the main idea?'),
(4, NULL, 3, 'What is the tone of the passage?'),

(5, NULL, 3, 'Convert this sentence to passive voice.'),
(5, NULL, 3, 'What is the subject in this sentence?'),
(5, NULL, 3, 'Which sentence is in direct speech?'),
(5, NULL, 3, 'How do you change this sentence to reported speech?'),
(5, NULL, 3, 'Identify the object in the given sentence.'),
(5, NULL, 3, 'Which sentence follows proper sentence structure?'),
(5, NULL, 3, 'What type of clause is used in this sentence?'),
(5, NULL, 3, 'What is the main clause in this sentence?'),
(5, NULL, 3, 'Which sentence is grammatically correct?'),
(5, NULL, 3, 'Identify the dependent clause in this sentence.'),

(6, NULL, 3, 'What does "give up" mean?'),
(6, NULL, 3, 'Choose the correct meaning of "turn down".'),
(6, NULL, 3, 'Which sentence correctly uses "break up"?'),
(6, NULL, 3, 'What is the meaning of "run into"?'),
(6, NULL, 3, 'Choose the correct sentence using "take off".'),
(6, NULL, 3, 'Which phrasal verb means "to cancel"?'),
(6, NULL, 3, 'Identify the meaning of "put up with".'),
(6, NULL, 3, 'Which sentence correctly uses "set up"?'),
(6, NULL, 3, 'What does "bring up" mean in this sentence?'),
(6, NULL, 3, 'Choose the correct usage of "call off".'),

(7, NULL, 3, 'What is the noun form of "decide"?'),
(7, NULL, 3, 'Choose the correct prefix to form the opposite of "happy".'),
(7, NULL, 3, 'Which word is formed by adding the suffix "-ment" to "achieve"?'),
(7, NULL, 3, 'What is the adjective form of "beauty"?'),
(7, NULL, 3, 'Which root word does "television" come from?'),
(7, NULL, 3, 'What is the verb form of "success"?'),
(7, NULL, 3, 'Choose the correct suffix to form an adjective from "care".'),
(7, NULL, 3, 'Which of the following words is derived from "educate"?'),
(7, NULL, 3, 'What is the meaning of the prefix "mis-" in "misunderstand"?'),
(7, NULL, 3, 'Identify the word with the suffix "-ion" that forms a noun.'),

(8, NULL, 3, 'Which word is spelled correctly?'),
(8, NULL, 3, 'Which word has a silent letter?'),
(8, NULL, 3, 'Which of the following words is commonly misspelled?'),
(8, NULL, 3, 'How many syllables are in the word "development"?'),
(8, NULL, 3, 'Which of these words has the same pronunciation as "knight"?'),
(8, NULL, 3, 'Which word contains a double consonant?'),
(8, NULL, 3, 'Which word has the correct spelling: "recieve" or "receive"?'),
(8, NULL, 3, 'Identify the word with an irregular pronunciation.'),
(8, NULL, 3, 'Which of these words has a different vowel sound?'),
(8, NULL, 3, 'Which word has the same ending sound as "thought"?'),

(9, NULL, 3, 'Identify the incorrect word in this sentence: "She go to school every day."'),
(9, NULL, 3, 'Which sentence contains a grammar mistake?'),
(9, NULL, 3, 'Find the spelling error in this sentence.'),
(9, NULL, 3, 'Which sentence has a subject-verb agreement error?'),
(9, NULL, 3, 'Which sentence has incorrect word order?'),
(9, NULL, 3, 'Identify the wrong article in this sentence.'),
(9, NULL, 3, 'Which of the following sentences has a punctuation error?'),
(9, NULL, 3, 'Find the incorrect preposition in this sentence.'),
(9, NULL, 3, 'Which sentence contains a verb tense error?'),
(9, NULL, 3, 'Identify the redundant word in this sentence.'),

(10, NULL, 3, 'Where should the comma be placed in this sentence?'),
(10, NULL, 3, 'Which sentence is correctly capitalized?'),
(10, NULL, 3, 'Identify the correct punctuation for this sentence.'),
(10, NULL, 3, 'Which of the following sentences is written in formal English?'),
(10, NULL, 3, 'Where should the apostrophe go in "its"?'),
(10, NULL, 3, 'Which sentence has parallel structure?'),
(10, NULL, 3, 'Choose the correct transition word for this sentence.'),
(10, NULL, 3, 'Identify the sentence with correct sentence structure.'),
(10, NULL, 3, 'Which of the following is a run-on sentence?'),
(10, NULL, 3, 'Choose the correct sentence using quotation marks.');
